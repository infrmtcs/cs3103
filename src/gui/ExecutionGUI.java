...
public class ExecutionGUI {
	...
	private void initialize() {
		...
		panel_1.setBorder(new MatteBorder(0, 0, 0, 2, (Color) new Color(255, 0,
				0)));
		...
		panel_2.setBorder(new MatteBorder(0, 0, 0, 0, (Color) new Color(255, 0,
				0)));
	...
	public void realTimeDisplay(CrawlerResult crawlerResult) {
		...
		urlPanel.setBorder(new MatteBorder(2, 0, 0, 2, (Color) new Color(255,
				0, 0)));
		...
		latencyPanel.setBorder(new MatteBorder(2, 0, 0, 0, (Color) new Color(
				255, 0, 0)));
